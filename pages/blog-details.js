              ...
              <div className="row">
                <div className="bloglist__main">
                  <div className="list details">
                    <h4 className="title">
                      NFT owners have zero ownership of their digital arts:
                      report
                    </h4>
                    <p>
                      <svg
                    ...
                    <div className="content-d">
                      ...
                      <div className="main">
                        <p className="boild">
                          The non-fungible tokens (NFTs) owners have zero
                          intellectual property ownership of their content and
                          only one NFT collection in the top 25 platforms by
                          market capitalisation has attempted to confer
                          intellectual property rights to the purchasers of
                          digital arts, says a report.
                        </p>
                        <div className="image">
                          <img
                        ...
                        <p className="mb-15">
                          Most NFT operators "appear to have misled NFT
                          purchasers" about the extent of their rights.
                        </p>
                        <p className="mb-15">
                          The Creative Commons license, seen as a solution to
                          the restrictive licenses used by most projects,
                          "renders NFT ownership obsolete from a legal
                          perspective as it moves the intellectual property
                          fully into the public domain, making it impossible for
                          NFT holders to defend their ownership rights in
                          court," according to the report by Galaxy Digital
                          Research.
                        </p>
                        <p className="mb-15">
                          The report mentioned that without improvements in the
                          on-chain representation and transfer of intellectual
                          property rights from NFT issuers to NFT token holders,
                          the expansive vision of Web3 will remain unrealised.
                        </p>
                        <p className="mb-15">
                          The report analysed major NFT projects, like the Yuga
                          Labs project Bored Ape Yacht Club (BAYC), Gary
                          Vaynerchuk's VeeFriends, World of Women, and social
                          platforms Decentraland and Sandbox.
                        </p>
                        <p className="mb-15">
                          It found that only the 'World of Women' (WoW) NFT
                          collection differentiates itself from all the other
                          top 25 NFT projects by being the only to attempt to
                          transfer full IP rights to NFT holders.
                        </p>
                        <p className="mb-15">
                          'World of Women' attempts this through the provision
                          of a novel copyright assignment agreement.
                        </p>
                        <p className="mb-15">
                          "Under this copyright assignment agreement, WoW
                          attempts to create a governance structure in which the
                          copyright of each WoW NFT 'runs with' the NFT, such
                          that whoever owns the NFT owns the copyright," the
                          report mentioned.
                        </p>
                        <p className="mb-15">
                        ...
                        <p>
                          "As NFTs are still in their infancy stage, it is
                          critical for the NFT community to begin working on a
                          framework to properly give out IP rights to users
                          before mass adoption," the findings showed.
                        </p>
                        <div className="line" />
                        <div className="bottom">
                          ...
                          <ul className="list-tag">
                            <li>
                              <Link href="/blog-details">nfts</Link>
                            </li>
                            <li>
                              <Link href="/blog-details">crypto</Link>
                            </li>
                            <li>
                              <Link href="/blog-details">Grabit</Link>
                            </li>
                            <li>
                              <Link href="/blog-details">collection</Link>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="recent">
                        <div className="ac prev">
                          ...
                          <div>
                            ...
                            <Link href="/blog-details" className="title">
                              OpenSea NFT Marketplace to Solely Support
                              Ethereum’s Upgraded...
                            </Link>
                          </div>
                        </div>
                        <div className="ac next">
                          ...
                          <div>
                            ...
                            <Link href="/blog-details" className="title">
                              MTV Music Awards to See Eminem, Snoop Dogg Perform
                              in Bored...
                            </Link>
                          </div>
                        </div>
                      ...
                      <div className="comment">
                        ...
                        <div className="comment-box s1">
                          ...
                          <div className="info">
                            ...
                            <p className="text">
                              Nullam ornare a magna quis aliquet. Duis suscipit
                              eros in suscipit venenatis. Pellentesque quis
                              efficitur leo. Maecenas accumsan est in nibh
                              interdum, quis dignissim neque scelerisque.
                            </p>
                  ...
                  <div className="sidebar">
                    ...
                    <div className="widget-sidebar category">
                      ...
                      <ul>
                        <li>
                          <Link href="#">
                            Cryptocurrency <span>(18)</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="#">
                            Block Chain <span>(57)</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="#">
                            Bit Coin <span>(5)</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="#">
                            Eatherium <span>(9)</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="#">
                            Buy Sale <span>(3)</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="#">
                            Online Trading <span>(81)</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="#">
                      ...
                      <ul>
                        ...
                        <li>
                          <div className="image">
                            <Link href="#">
                              <img
                                src="/assets/images/layouts/blog-03.png"
                                alt=""
                              />
                            </Link>
                          </div>
                          <div className="content">
                            ...
                            <Link href="/blog-details" className="title">
                              5 crypto predictions for second half of...
                            </Link>
                          </div>
                        </li>
                        <li>
                          ...
                          <div className="content">
                            ...
                            <Link href="/blog-details" className="title">
                              NFT owners have zero ownership of their digital...
                            </Link>
                          </div>
                        </li>
                        <li>
                          ...
                          <div className="content">
                            ...
                            <Link href="/blog-details" className="title">
                              Ethereum, Polygon rise up to 17% over...
                            </Link>
                          </div>
                        </li>
                      </ul>
                    ...
                    <div className="widget-sidebar tag">
                      ...
                      <ul>
                        ...
                        <li>
                          <Link href="/blog-details">Blockchain</Link>
                        </li>
                        <li>
                          <Link href="/blog-details">Coin</Link>
                        </li>
                        <li>
                          <Link href="/blog-details">ICO</Link>
                        </li>
                        <li>
                          <Link href="/blog-details">cryptocurrency</Link>
                        </li>
                        <li>
                          <Link href="/blog-details">Ttoken</Link>
                        </li>
                        <li>
                          <Link href="/blog-details">Digital</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
