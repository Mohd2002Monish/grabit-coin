...
//                                         <Link href="/" className="action-btn"><span>Get Connected</span></Link>
//                                     </div>
//                                     <CardSlider1 />
//                                 </div>
//                             </div>
...
//                                         <p className="mb-17">Grabit is the premier marketplace for nifties, which are digital items you can truly own for yourself</p>
...
//                                         </div>
//                                         <div className="content">
//                                             <Link href="/" className="h5 name">Jane Cooper</Link>
//                                             <p className="postion">
//                                                 Founder &amp; CEO
//                                             </p>
//                                         </div>
...
//                                         </div>
//                                         <div className="content">
//                                             <Link href="/" className="h5 name">Bobby Fischer</Link>
//                                             <p className="postion">
//                                                 Designer
//                                             </p>
//                                         </div>
...
//                                         </div>
//                                         <div className="content">
//                                             <Link href="/" className="h5 name">Jenny Wilson</Link>
//                                             <p className="postion">
//                                                 Designer
//                                             </p>
//                                         </div>
...
//                                         </div>
//                                         <div className="content">
//                                             <Link href="/" className="h5 name">Courtney Henry</Link>
//                                             <p className="postion">
//                                                 Designer
//                                             </p>
//                                         </div>
...
//                                         </div>
//                                         <div className="content">
//                                             <Link href="/" className="h5 name">Devon Lane</Link>
//                                             <p className="postion">
//                                                 Designer
//                                             </p>
//                                         </div>
