                ...
                <div className="col-xl-5 col-md-12">
                  <div className="banner__left">
                    <div className="block-text">
                      ...
                      <Link href="/" className="action-btn s1">
              ...
              <div className="row">
                <div className="col-xl-6 col-md-12">
                  <div className="block-text pd-0">
                    ...
                    <p className="mb-17">
                      Sunt in culpa qui officia dese runt mollit anim id est
              ...
              <div className="row">
                <div className="col-12">
                  <div className="block-text center">
                    <h6 className="sub-heading">
                      <span>NFT Portfolio Collections</span>
                    </h6>
                    <h3 className="heading wow" data-splitting>
                      Checkout Our NFT <br />
                      Collections
              ...
              <div className="row">
                ...
                >
                  <div className="speciality-box">
                    ...
                    <h5 className="title">Safe Database</h5>
                    <p>
                ...
                >
                  <div className="speciality-box">
                    ...
                    <h5 className="title">verify payment</h5>
                    <p>
                      Oficia dese runt mollit anim id est labo met, consectetur
                      adipis
                    </p>
                ...
                >
                  <div className="blog-box">
                    ...
                    <div className="content center">
                      ...
                      <Link href="/blog-details" className="h5 title">
                        This crypto startup is offering zero trading fees on
                        crypto coins
                      </Link>
                    </div>
                  </div>
