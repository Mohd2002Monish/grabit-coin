  ...
  return (
    <>
      <Layout
        headerStyle={1}
        footerStyle={1}
        breadcrumbTitle="Visions & Mission"
      >
              ...
              <div className="row">
                <div className="col-xl-6 col-md-12">
                  <div className="block-text">
                    ...
                    <p className="mb-17">
                      Grabit aims to build a virtual reality environment, a real
                      metaverse for business activities, where all users can
                      easily bring their business activities to the network
                      environment, conduct the comprehensive digital
                      transformation of business operations, increase
                      outstanding efficiency with the maximum support of
                      technologies.
                    </p>
                  </div>
                  <div className="block-text">
                    ...
                    <p>
                      Grabit is conceptualized almost like the development of
                      the digital society and digital economy of the world
                      according to the comprehensive digital transformation
                      model (Digital Transformation) in the period of Industry
                      4.0 taking place very strongly all over the world starting
                      from the digitization period (Digitization) to the goal of
                      building a virtual super universe (Metaverse) is being
                      shaped.
                    </p>
                  </div>
                </div>
                <div className="col-xl-6 col-md-12">
                  <div className="about__right">
                    <div className="images">
                      ...
                      <img
                        className="img3"
                        src="/assets/images/layouts/about-03.png"
                        alt=""
                      />
                      <img
                        className="img4"
                        src="/assets/images/layouts/about-04.png"
                        alt=""
                      />
                      <img
                        className="img5"
                        src="/assets/images/layouts/about-05.png"
                        alt=""
                      />
                    </div>
                  </div>
