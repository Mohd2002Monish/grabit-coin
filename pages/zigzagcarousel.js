                  ...
                  <div className="banner__left">
                    <div className="block-text">
                      <h2 className="heading">
                        The best community centric{" "}
                        <span className="arlo_tm_animation_text_word" />{" "}
                        marketplace
                      </h2>
                      <p className="desc">
                        Nocyix is the premier marketplace for nifties, which are
              ...
              <div className="row rev">
                ...
                <div className="col-xl-6 col-md-12">
                  <div className="block-text">
                    ...
                    <p className="mb-17">
                      Grabit is the premier marketplace for nifties, which are
                      digital items you can truly own for yourself
                    </p>
                    <p className="mb-26">
                      Duis aute irure dolor in reprehenderit in voluptate velit
                      esse cillum dolore eu fugiat nulla pariatur. Excepteur
                      sint occae cat cupidatat non proident, sunt in culpa qui
                      officia dese runt mollit anim id est laborum velit esse
                      cillum dolore eu fugiat nulla pariatu epteur sint occaecat
                    </p>
                    <Link href="/" className="action-btn">
                    ...
                    <div className="roadmap-box">
                      ...
                      <div className="content">
                        ...
                        <p className="text">
                          ...
                          molestie ultrices nisi. Suspendisse in ipsum ante. Ut
                          rhoncus ligula dictum gravida.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="swiper-slide">
                        <div className="team-box">
                          <div className="image">
                            <Link href="/">
                              <img
                                src="/assets/images/layouts/team-01.png"
                                alt=""
                              />
                            </Link>
                          </div>
                          <div className="content">
                            <Link href="/" className="h5 name">
                              Jane Cooper
                            </Link>
                      ...
                      <div className="swiper-slide">
                        <div className="team-box">
                          <div className="image">
                            <Link href="/">
                              <img
                                src="/assets/images/layouts/team-02.png"
                                alt=""
                              />
                            </Link>
                          </div>
                      ...
                      <div className="swiper-slide">
                        <div className="team-box">
                          <div className="image">
                            <Link href="/">
                              <img
                                src="/assets/images/layouts/team-03.png"
                                alt=""
                              />
                            </Link>
                          </div>
                      ...
                      <div className="swiper-slide">
                        <div className="team-box">
                          <div className="image">
                            <Link href="/">
                              <img
                                src="/assets/images/layouts/team-04.png"
                                alt=""
                              />
                            </Link>
                          </div>
